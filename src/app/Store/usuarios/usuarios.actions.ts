...
export const enum usuariosTypeAction{
    LOAD_USUARIOS = '[LOAD_USUARIO] LOAD USUARIOS',
    ...
    CREATE_USUARIO_SUCCESS = '[CREATE_USUARIO_SUCCESS] CRETA USUARIO SUCCESS',
    CREATE_USUARIO_FAIL = '[CREATE_USUARIO_FAIL] CREATE USUARIO FAIL',

    UPDATE_USUARIO = '[LOAD_USUARIO] UPDATE USUARIO',
    ...
    DELETE_USUARIO = '[DELETE_USUARIO] LOA USUARIO',
...
// Update Usuario
export const UpdatedUsuario = createAction(
...
export const UpdatedUsuarioFail = createAction(
